...
const AGENTS = [
  { id: "lead", labelKey: "s09_agent_lead", cx: SVG_W / 2, cy: 70, inbox: "lead.jsonl" },
  { id: "coder", labelKey: "s09_agent_coder", cx: 140, cy: 230, inbox: "coder.jsonl" },
  { id: "reviewer", labelKey: "s09_agent_reviewer", cx: SVG_W - 140, cy: 230, inbox: "reviewer.jsonl" },
] as const;
...
export default function AgentTeams({ title }: { title?: string }) {
  ...
  const steps = Array.from({ length: 7 }, (_, i) => ({
    title: t(`s09_step${i}_title`),
    desc: t(`s09_step${i}_desc`),
  }));
